        ...
        <div class="home-banner">
            <div class="banner-container">
                ...
                <div class="blog-contact animated zoomIn">
                    ...
                    <a class="qq circular icon button" data-content="1626680964" data-position="bottom center">
                        <i class="qq icon"></i>
                    </a>
                </div>
                ...
                <div class="ui stackable grid">
                    ...
                    <div class="eleven wide column">
                            ...
                            <div class="ui middle aligned two column grid my-shadow">
                                ...
                                <div class="right aligned column">
                                    <h4 class="ui header m-inline-block m-text"
                                        ...
                                        根据"{{ pagination.queryString }}"的搜索结果</h4>
                                    共 <h2 class="ui orange header m-inline-block m-text-thin">{{ pagination.total }}
                                    </h2> 篇
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ui attached  segment my-blog-shadow">
                            ...
                            <div class="ui padded vertical segment m-padded-tb-large" v-for="item in dataList"
                                :key="item.blogId">
                                <div class="ui middle aligned mobile reversed stackable grid">
                                    <div class="eleven wide column" style="cursor:pointer;">
                                        ...
                                        <div class="ui grid">
                                            <div class="eleven wide column">
                                                <div class="ui mini horizontal link list">
                                                    <div class="item">
                                                        ...
                                                        <div class="content"><a class="header">{{ item.nickname }}</a>
                                                        </div>
                                                    </div>
                                                    <div class="item">
                                            ...
                                            <div class="right aligned five wide column">
                                                <a target="_blank"
                                                    class="ui my-blue basic label m-padded-tiny m-text-thin">{{
                                                            item.typeName
                                                    }}</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="five wide column">
                                        <a target="_blank">
                                            <img v-bind:src=item.firstPicture @click="toBlog(item.blogId)" alt=""
                        ...
                        <div class="ui bottom attached segment my-blog-shadow">
                            <div class="pagination-container">
                                <el-pagination class="pagiantion" @size-change="handleSizeChange"
                                    @current-change="handleCurrentChange" :current-page="pagination.currentPage"
                                    :page-sizes="[2, 6, 10, 15]" :page-size="pagination.pageSize"
                    ...
                    <div class="five wide column" style="left: 34px !important;">
                        ...
                        <div class="ui segments my-shadow">
                            <div class="ui secondary segment">
                                <div class="ui two column grid">
                                    ...
                                    <div class="right aligned column">
                                        <a href="/#/types" target="_blank">more <i
                            ...
                            <div class="ui my-blue segment">
                                <div class="ui fluid vertical menu">
                                    <template v-for="(item, index) in typeList">
                                        <a class="item" v-if='index < 6' :key="item.typeId"
                        ...
                        <div class="ui segments m-margin-top-large my-shadow">
                            <div class="ui secondary segment">
                                <div class="ui two column grid">
                                    ...
                                    <div class="right aligned column">
                                        <a href="/#/tags" target="_blank">more <i
                                                class="angle double right icon"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="ui my-blue segment">
                                <template v-for="(item, index) in tagList">
                                    <a target="_blank" class="ui my-blue basic left pointing label m-margin-tb-tiny"
                                        v-if='index < 15' :key="item.tagId" @click="toTag(item.tagId)">
                        ...
                        <div class="ui segments m-margin-top-large my-shadow">
                            ...
                            <div class="ui segment" v-for="item in latestList" :key="item.blogId">
                                <a target="_blank" class="m-black m-text-thin" style="cursor:pointer;"
                                    v-text="item.title" @click="toBlog(item.blogId)"></a>
                            </div>
                        </div>
